...
export default function AddCompanyView({ onConfirm, onClose }) {
          ...
          <DialogPanel
            ...
            <div className='mt-5 sm:mt-4 sm:flex sm:flex-row-reverse'>
              <button
                type='button'
                onClick={onConfirm}
                className='inline-flex w-full justify-center rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white shadow-sm hover:opacity-70 sm:ml-3 sm:w-auto'>
                Añadir
              </button>
              <button
                type='button'
